...
def shop_signup():
    ...
    if account:
       ...
       msg = 'Invalid email address!'
        ...
        my_contact = contact
        my_number = phonenumbers.parse(my_contact, "PK")
    ...
    elif not username or not password or not email or not contact or not city or not market or not shopname or not shopaddress:
        msg = 'Please fill out the form!'
    else:
